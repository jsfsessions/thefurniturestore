...
import static com.itr.twilio.TwilioCredentials.ACCOUNT_SID;
import static com.itr.twilio.TwilioCredentials.AUTH_TOKEN;
...
public final class TwilioHelper {
    ...
    public static void sendMessage(String toNumber, String fromNumber, String messageBody, String mediaUrl) {
        ...
        try {
            Message message = Message.creator(new PhoneNumber(toNumber), new PhoneNumber(fromNumber), messageBody)
